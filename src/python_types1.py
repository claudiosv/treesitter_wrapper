...
class ArgumentList(Type):
   ...
   children: list[Union["DictionarySplat", "Expression", "KeywordArgument", "ListSplat", "ParenthesizedExpression"]]
...
class CasePattern(Type):
   ...
   children: list[Union["AsPattern", "ClassPattern", "ComplexPattern", "ConcatenatedString", "DictPattern", "DottedName", "FalseT", "Float", "Integer", "KeywordPattern", "ListPattern", "NoneT", "SplatPattern", "String", "TrueT", "TuplePattern", "UnionPattern"]]
...
class KeywordPattern(Type):
   ...
   children: list[Union["ClassPattern", "ComplexPattern", "ConcatenatedString", "DictPattern", "DottedName", "FalseT", "Float", "Identifier", "Integer", "ListPattern", "NoneT", "SplatPattern", "String", "TrueT", "TuplePattern", "UnionPattern"]]
...
class UnionPattern(Type):
   ...
   children: list[Union["ClassPattern", "ComplexPattern", "ConcatenatedString", "DictPattern", "DottedName", "FalseT", "Float", "Integer", "ListPattern", "NoneT", "SplatPattern", "String", "TrueT", "TuplePattern", "UnionPattern"]]
